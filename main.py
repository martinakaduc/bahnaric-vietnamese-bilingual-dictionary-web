...
def data1():
    ...
    # khkt_query = khkt_query.offset(start).limit(length)
    # ttcs_query = ttcs_query.offset(start).limit(length)
    # vhtt_query = vhtt_query.offset(start).limit(length)
    # khcn_query = khcn_query.offset(start).limit(length)
